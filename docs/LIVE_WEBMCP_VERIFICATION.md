...
| Coupon application | Pass — the coupon field has an adjacent Apply action that chooses an 8%, 12%, 15%, or 20% surprise discount and updates the discount row, total, and Pay label immediately. |
