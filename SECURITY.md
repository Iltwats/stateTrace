...
actions, the state you expected, and the state you observed. A saved regression
fixture produced by the `save_regression_fixture` WebMCP tool is the ideal
attachment — it makes the trace deterministically replayable.
